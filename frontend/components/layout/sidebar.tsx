...
export function Sidebar() {
  return (
    <aside className="hidden min-h-screen w-[220px] shrink-0 border-r border-border/60 bg-background/54 px-3 py-4 backdrop-blur-xl xl:block">
      ...
      <div className="mt-6 rounded-lg border border-border/70 bg-card/56 p-3">
